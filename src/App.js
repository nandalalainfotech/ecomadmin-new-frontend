...
import CatCreateProductScreen from "./screens/catCreateProdScreen";
import CatUpdateProductScreen from "./screens/catUpdateProdScreen";
          ...
          <Box sx={{ display: "flex" }}>
            ...
            >
              ...
              <Routes>
                ...
                <Route
                  path="/productadd"
                  element={<CatCreateProductScreen />}
                ></Route>
                <Route
                  path="/productupdate/:id"
                  element={<CatUpdateProductScreen />}
                ></Route>
                <Route
                  path="/productadd/:id"
